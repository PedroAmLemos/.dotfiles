...
myHandleEventHook = dynamicPropertyChange "WM_NAME" (title =? "Spotify" --> move )
    where move = doShift ( myWorkspaces !! 6)

myModMask :: KeyMask
myModMask  = mod4Mask

myWorkspaces = [" dev ", " www ", " dev2 ", " www2 ", " vmware ", " chat ", " mus ", " vid ", " gfx "]
